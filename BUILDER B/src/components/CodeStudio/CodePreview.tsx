...
export const CodePreview: React.FC<CodePreviewProps> = ({
  ...
  const gradleCode = generateBuildGradleKts(config);
            ...
            >
              ...
              <div className="flex-1 p-4 overflow-x-auto leading-6 whitespace-pre font-mono select-text">
                {lines.map((line, idx) => {
                  ...
                  } else if (line.includes("@Composable") || line.includes("@OptIn")) {
                  ...
                  } else if (line.includes("Modifier") || line.includes("MaterialTheme")) {
                    color = "text-blue-300";
                  }
