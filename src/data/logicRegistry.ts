...
export const EVENT_DEFINITIONS: EventDefinition[] = [
  ...
  {
    id: "OnAppPause",
    name: "On App Pause (Background)",
    category: "lifecycle",
    description: "Runs when the app is minimized or placed into background.",
  ...
  },
  {
    ...
    name: "On Screen Orientation Changed",
    category: "lifecycle",
    description: "Fires when device rotates between portrait and landscape modes.",
    badgeColor: "bg-blue-500/20 text-blue-400 border-blue-500/40",
  },
  {
    id: "OnPermissionGranted",
    name: "On Permission Granted",
    category: "lifecycle",
    description: "Fires when user allows a requested runtime system permission.",
    badgeColor: "bg-teal-500/20 text-teal-400 border-teal-500/40",
  },
  {
    id: "OnPermissionDenied",
    name: "On Permission Denied",
    category: "lifecycle",
    description: "Fires when user denies or cancels a runtime system permission.",
    badgeColor: "bg-red-500/20 text-red-400 border-red-500/40",
  },
  {
    id: "OnErrorOccurred",
    name: "On Error Occurred",
    category: "lifecycle",
    description: "Catch-all event for uncaught runtime exceptions or network failures.",
    badgeColor: "bg-rose-500/20 text-rose-400 border-rose-500/40",
  },
  {
    id: "OnKeyboardVisibilityChanged",
    name: "On Keyboard Visibility Changed",
    category: "input",
    description: "Fires when software IME keyboard expands or collapses.",
    badgeColor: "bg-violet-500/20 text-violet-400 border-violet-500/40",
  },
  {
    id: "OnSharedIntentReceived",
    name: "On Shared Data / Link Received",
    category: "lifecycle",
    description: "Fires when external apps share content or deep link URL to this app.",
    badgeColor: "bg-indigo-500/20 text-indigo-400 border-indigo-500/40",
  },
  {
    id: "OnDrawerOpened",
    name: "On Side Menu Opened",
    category: "lifecycle",
    description: "Fires when Navigation Drawer or Side Menu slides open.",
    badgeColor: "bg-sky-500/20 text-sky-400 border-sky-500/40",
  },
  {
    id: "OnDrawerClosed",
    name: "On Side Menu Closed",
    category: "lifecycle",
    description: "Fires when Navigation Drawer or Side Menu closes.",
    badgeColor: "bg-sky-500/20 text-sky-400 border-sky-500/40",
  },
...
export const ACTION_DEFINITIONS: ActionDefinition[] = [
  ...
  {
    type: "hideKeyboard",
    label: "Hide Software Keyboard",
    category: "device",
    description: "Dismiss active software IME input keyboard.",
    color: "text-blue-400 border-blue-500/40 bg-blue-500/10",
    defaultAction: {
  ...
  {
    type: "showKeyboard",
    label: "Show Software Keyboard",
    category: "device",
    description: "Focus target field and open software IME input keyboard.",
    color: "text-blue-400 border-blue-500/40 bg-blue-500/10",
    defaultAction: {
      actionType: "showKeyboard",
    },
  },
  {
    type: "moveTaskToBack",
    label: "Minimize App (Move Task to Back)",
    category: "device",
    description: "Place current Android activity task into background without killing process.",
    color: "text-amber-400 border-amber-500/40 bg-amber-500/10",
    defaultAction: {
      actionType: "moveTaskToBack",
    },
  },
  {
    type: "setKeepScreenOn",
    label: "Keep Screen Awake (WakeLock)",
    category: "device",
    description: "Prevent device screen timeout while user is on this screen.",
    color: "text-yellow-400 border-yellow-500/40 bg-yellow-500/10",
    defaultAction: {
      actionType: "setKeepScreenOn",
    },
  },
  {
    type: "startService",
