...
export const ConditionNode = memo(({ id, data, selected }: NodeProps) => {
  ...
  return (
    ...
    >
      ...
      <div className={`bg-slate-900 border-2 ${hasError ? "border-rose-500" : hasBreakpoint ? "border-rose-500" : "border-purple-500/70"} rounded-2xl overflow-hidden shadow-2xs`}>
        {/* Purple / Fuchsia Header Banner */}
        <div className={`px-3 py-1.5 flex items-center justify-between text-white ${
          hasError
