...
export interface AppBarActionItem {
  id: string;
  icon: string; // "search" | "bell" | "share-2" | "heart" | "settings" | "more-vertical" | "refresh-cw" | "filter"
  title: string;
...
export interface BottomNavItem {
  id: string;
  label: string;
  icon: string; // "home" | "search" | "compass" | "heart" | "bell" | "user" | "settings" | "shopping-bag"
  badge?: string;
  targetScreen?: string;
}
...
export interface ScreenProperties {
  ...
  // App Bar (TopAppBar / Action Bar)
  appBarVisible?: boolean;
  appBarVariant?: "small" | "center-aligned" | "medium" | "large";
  appBarTitle?: string;
  appBarSubtitle?: string;
  appBarNavIcon?: "none" | "back" | "menu" | "close" | "home" | "search" | "custom";
  appBarShowAppIcon?: boolean;
  appBarAppIconUrl?: string;
  appBarActions?: AppBarActionItem[];
  ...
  bottomNavStyle?: "material3" | "classic" | "pills";
  ...
  bottomNavShowLabels?: "always" | "selected" | "never";
  bottomNavItems?: BottomNavItem[];

  // System Chrome & Navigation
  systemNavMode?: "gesture" | "3-button";
  edgeToEdge?: boolean;

  // Splash Screen configuration & preview
  showSplashScreenPreview?: boolean;
  splashTitle?: string;
...
export interface ProjectConfig {
  ...
  // Primary Programming Language Architecture
...
// ==========================================
export type IdeTheme = "slate" | "midnight" | "light" | "nordic" | "high-contrast" | "high-contrast-logic" | "custom";
...
export interface CustomThemeColors {
  ...
  // Logic Blocks Canvas Overrides
  logicCanvasBg?: string;
  logicGridColor?: string;
  logicEdgeColor?: string;
  logicTriggerBorder?: string;
  logicActionBorder?: string;
  logicConditionBorder?: string;
  logicCommentBorder?: string;
}
...
export type CompanionConnectionType = "wifi" | "usb" | "cloud_relay" | "emulator";
...
export interface CompanionPayload {
  ...
  screensSummary: { id: string; name: string; isInitial?: boolean }[];
  timestamp: number;
  version: string;
}
...
export interface CompanionSession {
  ...
  connectionType: CompanionConnectionType;
  connectedDevice: CompanionDevice | null;
