  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="flex-1 font-medium">Add Event</span>
      ...
      >
        ...
        <span className="flex-1 font-medium">Add Action / Method</span>
      ...
      >
        ...
        <span className="flex-1 font-medium">Add If / Else</span>
