    ...
    >
      ...
      <div className="px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-slate-400 border-b border-slate-800/80 mb-1 flex items-center justify-between">
        <span className="truncate max-w-[140px]">
          {node.type === "trigger"
            ? `Event: ${nodeData.componentName || "Component"}`
            : node.type === "condition"
            ? "If / Else"
            : node.type === "apiBranch"
            ? "API Method"
            : `Method: ${nodeData.action?.actionType || "Action"}`}
        </span>
        <span
        ...
        >
          {node.type === "trigger" ? "event" : node.type}
        </span>
      </div>
      ...
      {node.type === "trigger" && (
        <>
          ...
          >
            ...
            <span className="flex-1 font-medium">Edit Event</span>
          </button>
          ...
          >
            ...
            <span className="flex-1 font-medium">Test This Event</span>
          </button>
          ...
          >
            ...
            <span className="flex-1 font-medium">Delete Event</span>
          </button>
