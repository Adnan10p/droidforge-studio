      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-2.5">
            ...
            {onOpenBuilderSettings && (
              <button
                id="dashboard-builder-settings-btn"
                type="button"
                onClick={onOpenBuilderSettings}
                title="Customize Builder IDE Appearance, Theme, and Workstation Preferences"
              ...
              >
                <Sliders className="w-4 h-4 text-indigo-600 stroke-[2.2]" />
            ...
            {displayedProjects.map((project) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {/* Top Row: Active tag + Language Badge + Status Badge */}
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1.5">
                        {isActive && (
                          <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-white/95 text-blue-700 shadow-xs flex items-center gap-1 backdrop-blur-xs">
                            <CheckCircle2 className="w-3 h-3 text-blue-600" />
                            <span>Active</span>
                          </span>
                        )}
                        <span
                          className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold shadow-xs backdrop-blur-xs flex items-center gap-1 ${
                            project.config.language === "java"
                              ? "bg-amber-500/95 text-white"
                              : "bg-violet-600/95 text-white"
                          }`}
                        >
                          <Code2 className="w-3 h-3" />
                          <span>{project.config.language === "java" ? "Java" : "Kotlin"}</span>
                        </span>
                      </div>
