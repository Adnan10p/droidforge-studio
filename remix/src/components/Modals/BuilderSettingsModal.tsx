...
const ColorInputRow: React.FC<ColorInputRowProps> = ({
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 p-3 rounded-xl bg-slate-50/90 border border-slate-200/80 hover:border-slate-300 transition shadow-2xs">
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <label
          htmlFor={`picker-${id}`}
          className="w-8 h-8 rounded-lg border-2 border-slate-300 shadow-2xs cursor-pointer flex items-center justify-center transition hover:scale-105 relative shrink-0 overflow-hidden"
        ...
        <div className="relative">
          <input
            ...
            placeholder="#000000"
            maxLength={7}
            className="w-24 px-2 py-1 text-xs font-mono font-semibold rounded-lg bg-white border border-slate-300 text-slate-800 uppercase focus:outline-none focus:ring-2 focus:ring-indigo-500 shadow-2xs"
          />
        </div>
...
type SettingsSection = "appearance" | "canvas" | "code" | "workflow";
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 animate-in fade-in duration-150">
      <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden text-slate-800">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-base font-bold text-slate-900">Builder Settings</h3>
        ...
        <div className="px-6 py-2.5 bg-amber-50/95 border-b border-amber-200/90 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 text-xs text-amber-900">
          <div className="flex items-center gap-2">
            <ShieldCheck className="w-4 h-4 text-amber-600 shrink-0" />
            <span>
              <strong>Workstation IDE Scope:</strong> These settings personalize this Builder Studio interface (themes, fonts, canvas snapping). They do <u>not</u> change your Android app screens or APK colors.
            </span>
          </div>
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-56 border-r border-slate-200/80 bg-slate-50/60 p-3 space-y-1 shrink-0 overflow-y-auto">
            <button
              type="button"
            ...
            {activeSection === "appearance" && (
              <div className="space-y-6 animate-in fade-in duration-100">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {settings.theme !== "custom" && (
                      <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1 rounded-xl text-xs font-bold text-indigo-600 bg-indigo-50 hover:bg-indigo-100 border border-indigo-200 transition cursor-pointer"
                      >
                    ...
                    {(Object.keys(THEME_PREVIEW_MAP) as IdeTheme[]).map((themeKey) => {
                      ...
                      return (
                        ...
                        >
                          <div className="space-y-1.5">
                            <div className="flex items-center justify-between">
                              <span className="text-xs font-bold text-slate-900 flex items-center gap-1.5">
                                {isCustom && <Paintbrush className="w-3.5 h-3.5 text-indigo-600" />}
                          ...
                          {/* Mini visual swatch */}
                          <div className="mt-3 flex items-center gap-1.5 p-1.5 rounded-lg bg-slate-100 border border-slate-200/60">
                            <div
                            ...
                            />
                            <div
                              className="w-4 h-4 rounded border border-black/10 flex items-center justify-center text-[8px] font-bold"
                ...
                <div className="pt-4 border-t border-slate-200/90 space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 bg-gradient-to-r from-indigo-50/80 via-blue-50/60 to-purple-50/80 p-3.5 rounded-2xl border border-indigo-100">
                    <div>
                      <h4 className="text-sm font-bold text-slate-900 flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      <button
                        ...
                        className="flex items-center gap-1 px-2.5 py-1 text-xs font-semibold rounded-lg bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 transition shadow-2xs cursor-pointer"
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-2">
                      {CUSTOM_PALETTE_PRESETS.map((preset) => (
                        <button
                          ...
                          className="flex flex-col items-center p-2 rounded-xl border border-slate-200 hover:border-indigo-400 bg-white hover:bg-indigo-50/30 transition text-center shadow-2xs group cursor-pointer"
                        >
                          ...
                          <span className="text-[11px] font-bold text-slate-800 group-hover:text-indigo-600 truncate w-full">
                            {preset.name}
                          </span>
                        </button>
                      ))}
                  ...
                  <div className="p-3.5 rounded-2xl border border-slate-200/90 shadow-xs bg-slate-50/50 space-y-2.5">
                ...
                <div className="pt-4 border-t border-slate-100">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 mt-3">
                    {(
                      [
                        { id: "dots", label: "Dot Matrix", desc: "Subtle dots" },
                        { id: "blueprint", label: "Blueprint", desc: "Engineering grid" },
                        { id: "solid", label: "Minimal Solid", desc: "Clean flat" },
                        { id: "dark-grid", label: "Dark Tech", desc: "Obsidian grid" },
                ...
                <div>
                  ...
                  <div className="space-y-3 mt-3">
                    ...
                    <div className="flex items-center justify-between p-3.5 bg-slate-50 rounded-xl border border-slate-200/80">
                      <div>
                        <div className="text-xs font-bold text-slate-900">Snap to Material Grid</div>
                    ...
                    {settings.snapToGrid && (
                      <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200/80 flex items-center justify-between">
                        <div>
                          <div className="text-xs font-bold text-slate-900">Grid Unit Size</div>
                          <div className="text-[11px] text-slate-500">
        ...
        <div className="px-6 py-4 bg-slate-50 border-t border-slate-200/80 flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={onClose}
            className="px-5 py-2 rounded-xl text-white font-semibold text-xs transition shadow-xs flex items-center gap-1.5 active:scale-95"
            style={{ backgroundColor: currentAccent.hex }}
          >
