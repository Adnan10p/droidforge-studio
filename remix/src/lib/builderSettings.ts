...
export const CUSTOM_PALETTE_PRESETS: CustomPalettePreset[] = [
  ...
  {
    id: "high-contrast-logic",
    name: "High Contrast Logic",
    desc: "Optimized for LogicBlocksEditor: deep obsidian canvas, luminous borders, high-visibility wires, and crisp emerald/amber/blue hierarchy",
    colors: {
      shellBg: "#06080F",
      cardBg: "#0C1220",
      cardInnerBg: "#050912",
      ...
      accentColor: "#38BDF8",
      accentTextColor: "#000000",
      logicCanvasBg: "#030712",
      logicGridColor: "#334155",
      logicEdgeColor: "#38BDF8",
      logicTriggerBorder: "#10B981",
      logicActionBorder: "#3B82F6",
      logicConditionBorder: "#F59E0B",
      logicCommentBorder: "#8B5CF6",
    },
  },
];
...
> = {
  ...
  "high-contrast-logic": {
    name: "High Contrast Logic",
    desc: "Vibrant contrast & luminous legibility optimized for logic blocks, wires, and decision branches",
    shellBg: "#050811",
    cardBg: "#0C1220",
    cardInnerBg: "#050912",
    textColor: "#FFFFFF",
